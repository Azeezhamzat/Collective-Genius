...
urlpatterns = [
    ...
    re_path(r'^(?P<organisation_slug>[-\w_]+)/', include([
        ...
        path('synthesis/',
             include(('apps.synthesis.urls', 'a4_candy_synthesis'),
                     namespace='a4_candy_synthesis')),
        path('argumentmapping/',
             include(('apps.argumentmapping.urls',
                      'a4_candy_argumentmapping'),
                     namespace='a4_candy_argumentmapping')),
        path('summarization/',
             include(('apps.summarization.urls', 'a4_candy_summarization'),
                     namespace='a4_candy_summarization')),
        path('deduplication/',
             include(('apps.deduplication.urls', 'a4_candy_deduplication'),
                     namespace='a4_candy_deduplication')),
        path('search/',
             include(('apps.search.urls', 'a4_candy_search'),
                     namespace='a4_candy_search')),
        path('documentrevisions/',
             include(('apps.documentrevisions.urls',
                      'a4_candy_documentrevisions'),
                     namespace='a4_candy_documentrevisions')),
        path('moderationlog/',
             include(('apps.moderationlog.urls',
                      'a4_candy_moderationlog'),
                     namespace='a4_candy_moderationlog')),
        path('opendata/',
             include(('apps.opendata.urls', 'a4_candy_opendata'),
                     namespace='a4_candy_opendata')),
        path('pushnotifications/',
             include(('apps.pushnotifications.urls',
                      'a4_candy_pushnotifications'),
                     namespace='a4_candy_pushnotifications')),
    ])),
