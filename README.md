...
* **Liquid democracy** — [delegate your vote](./apps/delegation) to someone you trust instead of voting directly; they can delegate onward in turn, and your vote follows the chain to whoever finally votes. Delegation cycles and dead ends safely abstain instead of being miscounted, and every direct voter can see how many delegated votes currently route through them
...
* **Push notifications** — real [Web Push](./apps/pushnotifications) (no third-party push provider needed) for project followers: new synthesis results, and a phase-ending-soon reminder sent once per phase
