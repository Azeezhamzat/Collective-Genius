...
class QuestionsComponent(ModuleFormSetComponent):
    identifier = 'forecasting_questions'
    weight = 20
    label = _('Questions')

    form_title = _('Edit forecasting questions')
    form_class = forms.QuestionFormSet
    form_template_name = \
        'a4_candy_forecasting/includes/question_formset.html'
    ...
    def get_base_url(self, module):
        return reverse(
            'a4dashboard:dashboard-forecasting_questions-edit', kwargs={
